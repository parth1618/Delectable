...
public class TestDelectable{
	...
	@Test(expected = MenuManager.InvalidItemPriceForUpdateException.class)
	...
	@Test(expected = OrderManager.InvalidOrderDetailException.class)
	...
	@Test
	public void test28_test_customer_with_added_customer(){
		assertEquals(3,customerManager.getAllCustomer().size());
	}
	
	@Test
	public void test29_test_customer_get_customer_by_id_isNil(){
	...
	@Test
	public void test30_test_customer_known_alias(){
	...
	@Test
	public void test31_test_customer_get_all_customer_with_query_string(){
	...
	@Test
	public void test32_order_cancel_order() throws ParseException{
		int id = 104;
	...
	@Test
	public void test33_admin_change_order_delivery_status(){
		int id = 106;
		assertEquals(OrderStatus.OPEN, orderManager.getOrder(id).getStatus());
	...
	@Test 
	public void test34_customer_get_customer_order_history(){
		int id1 = 101, id2 = 102, id3 = 103;
	...
	@Test
	public void test35_admin_check_order_isNil(){
		int id1 = 101, id2 = 102, id3 = 103, id4 = 104, id5 = 105, id6 = 106,invalid_id = 107;
	...
	@Test 
	public void test36_get_all_order_by_date_query_string() throws ParseException{
		String date1 = DateUtility.getFormattedDateToday(), date2 = "20160521", invalid_date = "20160601";
		
		assertEquals(2,orderManager.getAllOrder(date1).size());
	...
	@Test
	public void test37_report_get_four_report_list(){
		assertEquals(4, reportManager.getReportList().size());
	}
	
	@Test
	public void test38_report_check_for_null_report(){
	...
	@Test
	public void test39_report_get_report_801_today_with_and_without_query_string() throws ParseException{
		OrderDeliveryReport report = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_801, null, null);
		
		assertTrue(report.getStart_date().equals("Not Applicable"));
		assertTrue(report.getEnd_date().equals("Not Applicable"));
		assertEquals(2,report.getOrderList().size());
		
		OrderDeliveryReport report2 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_801, "20160501", null);
		
		assertTrue(report2.getStart_date().equals("Not Applicable"));
		assertTrue(report2.getEnd_date().equals("Not Applicable"));
		assertEquals(2,report2.getOrderList().size());
		
		OrderDeliveryReport report3 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_801, "20160401", "20160430");
		
		assertTrue(report3.getStart_date().equals("Not Applicable"));
		assertTrue(report3.getEnd_date().equals("Not Applicable"));
		assertEquals(2,report3.getOrderList().size());
		
		OrderDeliveryReport report4 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_801, null, "20160430");
		
		assertTrue(report4.getStart_date().equals("Not Applicable"));
		assertTrue(report4.getEnd_date().equals("Not Applicable"));
		assertEquals(2,report4.getOrderList().size());
	}
	
	@Test
	public void test40_report_get_report_802_tomorrow_with_and_without_query_string() throws ParseException{
		...
		OrderDeliveryReport report2 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_802, "20160501", null);
		
		assertTrue(report2.getStart_date().equals("Not Applicable"));
		assertTrue(report2.getEnd_date().equals("Not Applicable"));
		assertEquals(1,report2.getOrderList().size());
		
		OrderDeliveryReport report3 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_802, "20160401", "20160430");
		
		assertTrue(report3.getStart_date().equals("Not Applicable"));
		assertTrue(report3.getEnd_date().equals("Not Applicable"));
		assertEquals(1,report3.getOrderList().size());
		
		OrderDeliveryReport report4 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_802, null, "20160430");
		
		assertTrue(report4.getStart_date().equals("Not Applicable"));
		assertTrue(report4.getEnd_date().equals("Not Applicable"));
		assertEquals(1,report4.getOrderList().size());
		
	}
	
	@Test
	public void test41_report_get_report_804_delivery_with_and_without_query_string() throws ParseException{
		OrderDeliveryReport report = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_804, null, null);
		
		assertTrue(report.getStart_date().equals("Not Applicable"));
		assertTrue(report.getEnd_date().equals("Not Applicable"));
		assertEquals(6,report.getOrderList().size());
		
		OrderDeliveryReport report2 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_804, DateUtility.getFormattedDateToday(), null);
		
		assertTrue(report2.getStart_date().equals(DateUtility.getFormattedDateToday()));
		assertTrue(report2.getEnd_date().equals("Not Applicable"));
		assertEquals(6,report2.getOrderList().size());
		
		OrderDeliveryReport report3 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_804, "20160515", "20160530");
		
		assertTrue(report3.getStart_date().equals("20160515"));
		assertTrue(report3.getEnd_date().equals("20160530"));
		assertEquals(3,report3.getOrderList().size());
		
		OrderDeliveryReport report4 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_804, "20160601", "20160630");
		
		assertTrue(report4.getStart_date().equals("20160601"));
		assertTrue(report4.getEnd_date().equals("20160630"));
		assertEquals(0,report4.getOrderList().size());
		
		OrderDeliveryReport report5 = (OrderDeliveryReport)reportManager.generateReport(ReportList.RID_804, null, DateUtility.getFormattedDateTomorrow());
		
		assertTrue(report5.getStart_date().equals("Not Applicable"));
		assertTrue(report5.getEnd_date().equals(DateUtility.getFormattedDateTomorrow()));
		assertEquals(3,report5.getOrderList().size());
	}
	
	@Test
	public void test42_report_get_report_803_revenue_with_and_without_query_string() throws ParseException{
		RevenueReport report = (RevenueReport)reportManager.generateReport(ReportList.RID_803, null, null);
	
		assertTrue(report.getStart_date().equals("Not Applicable"));
		assertTrue(report.getEnd_date().equals("Not Applicable"));
		
		assert_total_revenue_report_value(report);
		
		RevenueReport report2 = (RevenueReport)reportManager.generateReport(ReportList.RID_803, DateUtility.getFormattedDateTomorrow(), null);
		
		assertTrue(report2.getStart_date().equals(DateUtility.getFormattedDateTomorrow()));
		assertTrue(report2.getEnd_date().equals("Not Applicable"));
		
		assert_total_from_date_revenue_report_value(report2);
		
		RevenueReport report3 = (RevenueReport)reportManager.generateReport(ReportList.RID_803, "20160515", "20160530");
		
		assertTrue(report3.getStart_date().equals("20160515"));
		assertTrue(report3.getEnd_date().equals("20160530"));
		
		assert_range_based_revenue_report_value(report3);
		
		RevenueReport report4 = (RevenueReport)reportManager.generateReport(ReportList.RID_803, null, "20160521");
		
		assertTrue(report4.getStart_date().equals("Not Applicable"));
		assertTrue(report4.getEnd_date().equals("20160521"));
		
		assert_total_to_date_revenue_report_value(report4);
		
		RevenueReport report5 = (RevenueReport)reportManager.generateReport(ReportList.RID_803, "20160601", "20160630");
		
		assertTrue(report5.getStart_date().equals("20160601"));
		assertTrue(report5.getEnd_date().equals("20160630"));
		
		assert_out_of_range_based_revenue_report_value(report5);
	}
	
	/*------------------------------Test For Testing Getting & Setter---------------------------------*/
	
	@Test
	public void test43_test_order_getter_methods(){
	...
	@Test(expected = OrderManager.OrderCanNotBeCancelledException.class)
	public void test46_test_cancel_order_for_today() throws ParseException{
		assertEquals(OrderStatus.OPEN, orderManager.getOrder(101).getStatus());
		orderManager.cancelOrder(101);
	}
	
	@Test
	public void test47_test_cateogry(){
	...
	@Test
	public void test48_create_personalInfo_orderDetail_with_blank_constructor(){
	...
	/*-------------------------------------- Revenue Report Assert------------------------------------*/
	
	private void assert_total_revenue_report_value(RevenueReport report){
		Revenue revenue = report.getRevenue();
	
		assertEquals(6, revenue.getOrders_placed());
		assertEquals(4, revenue.getOrders_open());
		assertEquals(1, revenue.getOrders_delivered());
		assertEquals(1, revenue.getOrders_cancelled());
		assertEquals(243.64, revenue.getFood_revenue(),0.01);

	}
	
	private void assert_total_from_date_revenue_report_value(RevenueReport report){
		Revenue revenue = report.getRevenue();
		
		assertEquals(4, revenue.getOrders_placed());
		assertEquals(2, revenue.getOrders_open());
		assertEquals(1, revenue.getOrders_delivered());
		assertEquals(1, revenue.getOrders_cancelled());
		assertEquals(153.8, revenue.getFood_revenue(),0.01);
	}
	
	private void assert_total_to_date_revenue_report_value(RevenueReport report){
		Revenue revenue = report.getRevenue();
	...
	private void assert_range_based_revenue_report_value(RevenueReport report){
		Revenue revenue = report.getRevenue();
		...
		assertEquals(5, revenue.getSurcharge_revenue(),0.01);
	}
	
	private void assert_out_of_range_based_revenue_report_value(RevenueReport report){
		...
		assertEquals(0, revenue.getFood_revenue(),0.01);
		assertEquals(0, revenue.getSurcharge_revenue(),0.01);
	}
	...
	private void createSixDummyOrder() throws ParseException{
		...
		o1 = new Order(DateUtility.getFormattedDateToday(), "10 West 31st ST, Chicago IL 60616", p1, "Room SB-214", odList_1);
		o2 = new Order(DateUtility.getFormattedDateToday(), "10 West 31st ST, Chicago IL 60616", p2, "Room SB-214", odList_2);
		o3 = new Order(DateUtility.getFormattedDateTomorrow(), "10 West 31st ST, Chicago IL 60616", p3, "Room SB-214", odList_3);
		o4 = new Order("20160517", "10 West 31st ST, Chicago IL 60616", p4, "Room SB-214", odList_4);
